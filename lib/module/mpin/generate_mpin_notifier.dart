...
class GenerateMpinNotifier extends ChangeNotifier {
  ...
  Future<void> generateMpin() async {
    ...
    if (result['value'] == 1) {
      ...
      _showResultDialog(
        isSuccess: true,
        message: 'MPIN berhasil digenerate untuk petugas $_namaPetugas.\n.',
      );
    } else {
      _showResultDialog(
        isSuccess: false,
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Apakah Anda yakin ingin generate MPIN untuk petugas ini?',
              ...
              Container(
                ...
                child: const Row(
                  children: [
                    ...
                    Expanded(
                      child: Text(
                        'Generate MPIN akan menghasilkan MPIN baru untuk petugas.',
