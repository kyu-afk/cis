import 'package:cis_menu/module/mpin/regenerate_mpin_notifier.dart';
...
class RegenerateMpinPage extends StatelessWidget {
  const RegenerateMpinPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => RegenerateMpinNotifier(context: context),
      child: Consumer<RegenerateMpinNotifier>(
  ...
  Widget _buildHeader() {
    return Container(
      ...
      color: colorPrimary,
      child: const Text("Regenerate MPIN",
  ...
  Widget _buildInfoBanner() {
    return Container(
      ...
      decoration: BoxDecoration(color: colorInfoBackground, borderRadius: BorderRadius.circular(12)),
      child: const Row(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(Icons.info_outline_rounded, color: colorInfoIcon, size: 20),
          SizedBox(width: 10),
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Proses pembuatan ulang MPIN untuk mengganti MPIN lama dengan MPIN baru.",
                    style: TextStyle(fontSize: 13, color: colorInfoText, height: 1.4)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildSearchSection(RegenerateMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
      ...
      child: Column(
        ...
        children: [
          ...
          SearchableDropdownPetugas(
            ...
            selectionValidator: MpinStatusValidator.forRegenerate,
          )
        ],
      ),
    );
  ...
  Widget _buildResultSection(RegenerateMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: colortextwhite,
      ...
      children: [
        ...
        Expanded(
            child: Text(val.isEmpty ? '-' : val,
                style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: colortextblack))),
      ],
    );
  }

  Widget _buildButtonSection(RegenerateMpinNotifier notifier) {
    return Row(
      children: [
        Expanded(
          flex: 2,
          child: OutlinedButton(
            ...
            child: const Text("Cancel",
                style: TextStyle(fontWeight: FontWeight.w600, color: colortextwhite)),
          ),
        ),
        ...
        Expanded(
          ...
          child: ElevatedButton(
            onPressed: notifier.isRegenerating ? null : () => notifier.regenerate(),
