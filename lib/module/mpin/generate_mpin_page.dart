import 'package:cis_menu/module/mpin/generate_mpin_notifier.dart';
...
class GenerateMpinPage extends StatelessWidget {
  const GenerateMpinPage({super.key});

  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => GenerateMpinNotifier(context: context),
      child: Consumer<GenerateMpinNotifier>(
  ...
  Widget _buildHeader() {
    return Container(
      ...
      color: colorPrimary,
      child: const Text("Generate MPIN",
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Proses pembuatan MPIN untuk kolektor baru. Masukkan nama kolektor baru",
  ...
  Widget _buildSearchSection(GenerateMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
  ...
  Widget _buildResultSection(GenerateMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: colortextwhite,
  ...
  Widget _buildButtonSection(GenerateMpinNotifier notifier) {
    return Row(
      children: [
        Expanded(
          flex: 2,
        ...
        Expanded(
          ...
          child: ElevatedButton(
            onPressed: notifier.isGenerating ? null : () => notifier.generateMpin(),
