import 'package:cis_menu/module/mpin/reset_mpin_notifier.dart';
...
class ResetMpinPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => ResetMpinNotifier(context: context),
      child: Consumer<ResetMpinNotifier>(
        ...
        children: [
          ...
          Expanded(
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("Proses reset MPIN untuk membuka blokir karena salah MPIN melebihi batas ketentuan.",
  ...
  Widget _buildSearchSection(ResetMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
      ...
      child: Column(
        ...
        children: [
          ...
          SearchableDropdownPetugas(
            ...
            selectionValidator: MpinStatusValidator.forReset,
          )
                  ],
      ),
    );
  ...
  Widget _buildResultSection(ResetMpinNotifier notifier) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(
        color: colortextwhite,
  ...
  Widget _buildButtonSection(ResetMpinNotifier notifier) {
    return Row(
      children: [
        Expanded(
          flex: 2,
        ...
        Expanded(
          ...
          child: ElevatedButton(
            onPressed: notifier.isResetting ? null : () => notifier.resetMpin(),
