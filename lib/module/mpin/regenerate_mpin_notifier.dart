...
class RegenerateMpinNotifier extends ChangeNotifier {
  final BuildContext context;

  RegenerateMpinNotifier({required this.context});
  ...
  /// ID petugas yang sudah berhasil di-regenerate MPIN-nya.
  ...
  Future<void> regenerate() async {
    ...
    final result = await CollectorRepository.regenerateMpin(
    ...
    if (result['value'] == 1) {
      ...
      _showResultDialog(
        ...
        message: result['message']?.toString().isNotEmpty == true
            ? result['message']
            : 'Regenerate MPIN gagal, silakan coba lagi.',
      );
    }
  }
      ...
      builder: (_) => Dialog(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Row(children: [
                const Icon(Icons.refresh, color: colorPrimary, size: 22),
                const SizedBox(width: 10),
                const Text('Konfirmasi Regenerate MPIN',
